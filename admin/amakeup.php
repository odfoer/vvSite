...
<body>
	...
	<!--header-->
	<?php $makeup=("active"); include '../admin/aheader.php';?>
	<!--//header-->
	<!--banner-->
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
			<ul>
			<?php
				$resultmk = $mysqli->query("SELECT * FROM makeupfoto ORDER BY id ASC");
				while ($myrowmk = $resultmk->fetch_assoc()){
					$i = $myrowmk['id'];
				echo ("<li><a href='../images/makeup/".$myrowmk["mini"].".jpg'><img src='../images/makeup/".$myrowmk["big"].".jpg' alt='Вікторія Ващук | професійний весільний візажист-стиліст в Луцьку | (099)77-13-400' /><div></div></a>
				<form action='../scrypt/uploadfotomk.php' method='post' enctype='multipart/form-data'>
