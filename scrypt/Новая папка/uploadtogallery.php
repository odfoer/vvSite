...
<html lang="uk">
    ...
    <body>
        ...
        else $path_directory = '../img/togallery/';
        echo ("OK");
        ...
        exit ("Аватар должен быть в формате <strong>JPG,GIF или PNG</strong>"); 
                ...
                if (isset($description)) {
                        $id = $description; 
                        echo($id.$date);
                $result = mysql_query("SELECT id,foto FROM mainfoto WHERE id='$id'",$db);
                $myrow = mysql_fetch_assoc($result);
                if ($id == $myrow['id']){ 
                echo "yes-";
                echo $myrow['foto'];
                mysql_query("UPDATE mainfoto SET foto='$date' WHERE id='$id'",$db);
