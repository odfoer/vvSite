...
<body>
	<!--header-->
	<?php $hairs=("active"); include 'blocks/header.php';?>
	<!--//header-->
	<!--banner-->
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
			<ul>
			<?php
				$resultmk = $mysqli->query("SELECT * FROM hairsfoto ORDER BY id DESC");
				while ($myrowmk = $resultmk->fetch_assoc()){
				echo ("<li><a href='images/hairs/".$myrowmk["mini"].".jpg'><img src='images/hairs/".$myrowmk["big"].".jpg' alt='Вікторія Ващук | професійний весільний візажист-стиліст в Луцьку | (099)77-13-400' /><div class='glry-bgd'></div></a></li>");
				}
			?>	
			</ul>
			<div class="clearfix"> </div>
		</div>
<video  id=videoPlayer controls="controls"  width="100%" poster="index.files/html5video/www.victoria-visage.lutsk.ua.jpg" width="100%" title="www.victoria-visage.lutsk.ua" onended="var v=this;setTimeout(function(){v.play()},300)">
...
<param name="flashVars" value="autoplay=false&amp;controls=true&amp;fullScreenEnabled=true&amp;posterOnEnd=true&amp;loop=false&amp;poster=index.files/html5video/www.victoria-visage.lutsk.ua.jpg&amp;src=www.victoria-visage.lutsk.ua.m4v" />
 <embed src="index.files/html5video/flashfox.swf" width="100%" style="position:relative;"  flashVars="autoplay=false&amp;controls=true&amp;fullScreenEnabled=true&amp;posterOnEnd=true&amp;loop=false&amp;poster=index.files/html5video/www.victoria-visage.lutsk.ua.jpg&amp;src=www.victoria-visage.lutsk.ua.m4v"	allowFullScreen="true" wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer_en" />
</object>
</video>		
	</div>
	<!--//gallery -->
